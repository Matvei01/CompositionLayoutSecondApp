...
final class NewsHeaderCell: UICollectionReusableView, SupplementaryViewProtocol {
    static var reuseID: String = "NewsHeaderCell"
    ...
    private lazy var headerButton: UIButton = {
        let button = UIButton()
        button.setImage(.news, for: .normal)
        return button
    }()
...
// MARK: - Constraints
private extension NewsHeaderCell {
    func setConstraints() {
        NSLayoutConstraint.activate([
            ...
            headerButton.widthAnchor.constraint(equalToConstant: 21),
            headerButton.heightAnchor.constraint(equalToConstant: 21)
        ])
    }
}
